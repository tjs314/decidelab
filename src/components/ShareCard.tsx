          ...
          {rows.map((row) => (
            <div key={row.badge} style={{ display: 'flex', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexShrink: 0 }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '30%', background: '#676B82', textAlign: 'center', lineHeight: '37px', paddingBottom: '3px', fontSize: '26px', fontWeight: 700, color: '#0A0D2D', fontFamily: 'Arial, Helvetica, sans-serif', flexShrink: 0, overflow: 'hidden', boxSizing: 'border-box' }}>
                  {row.badge}
                </div>
