                ...
                <div>
                  ...
                  <div className="pt-1 pb-5">
                    <button
                      ...
                      className="w-full py-3.5 bg-transparent border-[1.5px] border-[var(--line)] rounded-xl text-[var(--ink2)] text-base font-semibold cursor-pointer font-[inherit] mt-2.5 transition-colors hover:border-[var(--orange)] hover:text-[var(--orange)]"
                    >
                      다시 테스트 해보기
                    </button>
                  </div>
